...
message(STATUS "wall_following: 2 messages, 0 services")

set(MSG_I_FLAGS "-Iwall_following:/home/lab/AutonomousToManual-PhysicalA2M_Completed/src/wall_following/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lab/AutonomousToManual-PhysicalA2M_Completed/src/wall_following/msg/drive_param.msg" NAME_WE)
add_custom_target(_wall_following_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "wall_following" "/home/lab/AutonomousToManual-PhysicalA2M_Completed/src/wall_following/msg/drive_param.msg" ""
)

get_filename_component(_filename "/home/lab/AutonomousToManual-PhysicalA2M_Completed/src/wall_following/msg/pid_input.msg" NAME_WE)
add_custom_target(_wall_following_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "wall_following" "/home/lab/AutonomousToManual-PhysicalA2M_Completed/src/wall_following/msg/pid_input.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wall_following)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wall_following\")")
  # install generated code
  install(
